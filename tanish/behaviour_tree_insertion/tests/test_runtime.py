...
from behaviour_tree_insertion.runtime import (
...
class BehaviourTreeRuntimeTests(unittest.TestCase):
    def test_bundled_isaac_demo_json_is_valid(self) -> None:
        ...
        self.assertIn("Thin connector lengthwise insert into slot", rendered)
        self.assertIn("Rotate and insert connector lengthwise into slot", rendered)
        self.assertIn("Find the connector", rendered)
