...
# Upright arm, gripper pointed down (same joint convention as UR family home).
UR5E_LULA_NAME = "UR5e"
UR5E_EE_FRAME = "tool0"
...
UR5E_LIVE_DAMPING_MULTIPLIER = 10.0
...
ALIGN_NUDGE_POS_MAX_M = 0.002
ALIGN_NUDGE_ROT_MAX_RAD = 0.05
