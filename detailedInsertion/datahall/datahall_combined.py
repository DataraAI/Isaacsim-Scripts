...
qsfp_reset_robot_runtime = qsfp_ns["reset_robot_runtime"]
qsfp_configure_viewport_only_layout = qsfp_ns.get("configure_viewport_only_layout")
qsfp_camera_pose_logger = qsfp_ns.get("log_viewport_camera_for_config")
