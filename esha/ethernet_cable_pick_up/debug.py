#!/usr/bin/env python3
"""Stereo visualization and debug file outputs.

Import only after SimulationApp has started (uses omni/pxr for stage markers).
"""
...
from perception import CableCorners, StereoCableObservation, StereoFrame
