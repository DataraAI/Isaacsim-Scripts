...
class RunLogger:
    ...
    def __post_init__(self) -> None:
        ...
        # Line-buffered so each JSON line is flushed on its trailing "\n",
        # surviving a hard kill without relying on a clean shutdown.
        ...
        self._write_meta(outcome="in_progress")
