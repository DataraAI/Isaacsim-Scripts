...
class AngledHandStereoHandoffRuntime(
    ...
    def note_perception_failure(self) -> None:
        """Reacquire image references without deleting stationary 3D evidence."""
    ...
    def capture_due(self) -> bool:
        """Stop camera inference after qualification and advance after settling."""
    ...
    def _advance_handoff_if_settled(self) -> None:
        """Issue one bounded translation toward the frozen preinsert goal."""
    ...
    def update_visual_servo_completion(self) -> None:
        """Complete frozen-goal alignment before guarded insertion begins."""
