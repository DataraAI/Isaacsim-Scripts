...
# runtime resolution and qualified front-plane control explicit. Installing the
# replacement back onto the base module ensures later `from config import CONFIG`
# imports inside project modules receive the same high-resolution object.
CONFIG = replace(
    _base_config.CONFIG,
    camera=replace(
